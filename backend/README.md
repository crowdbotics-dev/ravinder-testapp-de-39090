...
## Project Structure
    ...
    ├── ravinder_testapp_de_39090  # Django project configurations
...
1. Clone this repo and `cd ravinder_testapp_de_39090`
...
2. Clone this repo and `cd ravinder_testapp_de_39090`
